...
trait Profile:
   ...
   *
   * @param id The new id or current if not specified
   * @param name The new name or current if not specified
   * @param email The new email or current if not specified
   * @param password The new password or current if not specified 
   * @param settings The new settings or current if not specified
   * @return A new Profile instance with the updated fields
   */
  def copy(
            id: Option[String] = id,
            name: String = name,
 ...
 * @param settings Set of user settings/permissions
 */
case class UserProfile(
   ...
   * @param password The new password or current if not specified
   * @param settings The new settings or current if not specified
   * @return A new UserProfile instance with the updated fields
   */
  override def copy(
                     id: Option[String] = id,
                     name: String = name,
