...
/** Service trait for managing user profiles business logic.
  *
  * This trait defines the high-level operations available for managing user
  * profiles, abstracting the underlying repository implementation details.
  */
trait ProfileService:
  ...
  /** Retrieves a profile by its ID.
    ...
    * @return
    *   Some(Profile) if found, None if not found
    */
  ...
  /** Creates a new user profile.
    ...
    * @return
    *   The created profile with any system-generated fields populated
    */
  ...
  /** Updates an existing user profile.
    *
    * @param userProfile
    *   The profile with updated information
    * @return
    *   Some(Profile) if the profile was updated, None if not found
    */
  ...
  /** Deletes all profiles from the system.
    *
    * @return
    *   true if any profiles were deleted, false if system was empty
    */
  ...
  /** Lists all profiles in the system.
    *
    * @return
    *   A list containing all profiles
    */
